...
extends SettingComponent {
    ...
    public ModeComponent(Module module, ModeSetting setting, int x, int y, int width, int height) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.setting.getName() + " " + (Object)ChatFormatting.GRAY + this.setting.getValueEnum().toString(), (float)(this.x + 5), (float)(this.y + 2), this.module.isEnabled() ? -1 : (this.isInside(mouseX, mouseY) ? new Color(160, 160, 160).getRGB() : new Color(130, 130, 130).getRGB()));
